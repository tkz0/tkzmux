// AgentBridge — Claude Code's own session descriptor, and its projection into the generic
...
// the agent-blind half of the app, and the dependency runs AgentBridge → TkzCore, so TkzCore
